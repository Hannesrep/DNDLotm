        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              <Link href="/" className="transition-colors duration-300 font-medium text-victorian-charcoal hover:text-victorian-burgundy">
                Home
              </a>
              <Link href="/classes" className="transition-colors duration-300 font-medium text-victorian-burgundy">
                Klassen
              </a>
            </div>
            ...
            {classes.map((classItem, index) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href={classItem.secretUrl} className="flex items-center space-x-2 hover:opacity-100 transition-opacity">
                    <img
