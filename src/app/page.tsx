        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="/" className="transition-colors duration-300 font-medium text-victorian-burgundy">
                Home
              </a>
              <a href="/classes" className="transition-colors duration-300 font-medium text-victorian-charcoal hover:text-victorian-burgundy">
                Klassen
              </a>
            </div>
